...
function handleOccupyTransition(scene, occupyTransitionEffects) {
    ...
    var layerNames = occupyTransitionEffects.map(function (fx) { return fx.layerName; }); //[...new Set(occupyTransitionEffects.map(fx => fx.layerName))];
