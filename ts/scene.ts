...
function preload(this: Phaser.Scene):void {
    ...
    // mwctodo: does <object><any> hack actually work? is there a better way?
...
function checkAndAnimateMove(scene:Phaser.Scene, player:Phaser.GameObjects.Sprite, tdx:integer, tdy:integer) {
...
function checkMove(scene:Phaser.Scene, player:Phaser.GameObjects.Sprite, tdx:integer, tdy:integer) {
...
function animateMove(scene:Phaser.Scene, player:Phaser.GameObjects.Sprite, tdx:integer, tdy:integer) {
    playerMoving = true;
